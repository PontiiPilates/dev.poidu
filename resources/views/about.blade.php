...
<head>
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/91231794" style="position:absolute; left:-9999px;" alt="" />
        </div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
...
<body>
    ...
    {{-- <img src="/storage/images/landing/promo10.png" alt="image"> --}}
    ...
    <section class="container device text-center pt-5 pb-5">
        ...
        <div class="mb-5" style="height: 124px;">
            <a class="text-decoration-none d-block" href="/"><span class="text-decoration-none text-reset brand"
                    style="font-size: 72px; line-height: 72px"><b>Poidu</b></span></a>
        ...
        {{-- Action --}}
        <div class="mt-5">
            <a href="{{ route('events') }}" class="btn btn-accent rounded-element soft-shadow">Круто, хочу
                попробовать</a>
    ...
    <section class="container slider-mobile ps-0 pe-0 d-md-none">
        ...
        @foreach ($images as $image)
            <img class="soft-shadow rounded-element" src="/storage/images/landing/{{ $image }}.jpg"
                alt="{{ $image }}">
        @endforeach
    ...
    <section class="container-fluid slider-desctop d-none d-md-block ps-0 pe-0">
        ...
        @foreach ($images as $image)
            <img class="soft-shadow rounded-element ms-3 me-3" src="/storage/images/landing/{{ $image }}.jpg"
                alt="{{ $image }}">
        @endforeach
    ...
    <section class="container device text-center pt-5 pb-5 mt-5 mb-5">
        ...
        <div class="d-flex flex-column mb-4">
            ...
            <b>Сохраняет время</b>
            <p class="card-text">На Poidu все мероприятия находятся на одна стринице. Искать на одной странице быстрее,
                чем среди десятков групп, сообществ, каналов, чатов, сайтов и форумов.</p>
        </div>
        {{-- Фишка 1 --}}
        ...
        <div class="d-flex flex-column mb-4">
            ...
            <p class="card-text">Poidu не ограничен источниками информации и расширяет их постоянно. Поэтому знает о
                мероприятиях, про которые вы не подозревали!</p>
        </div>
        {{-- Фишка 2 --}}
        ...
        <div class="d-flex flex-column">
            ...
            <p class="card-text">Если вы знаете о мероприятии или организуете его сами, то можете добавить его на Poidu.
                Просто придерживайтесь тематического направления.</p>
        </div>
        {{-- Фишка 3 --}}

        {{-- Action --}}
        <div class="mt-5 text-center">
            <a href="{{ route('events') }}" class="btn btn-accent rounded-element soft-shadow">Мне начинает нравиться
                Poidu</a>
        </div>
        {{-- Action --}}
    ...
    {{-- Теги --}}
    <section class="container-fluid ps-0 pe-0 pt-5 pb-5 mt-5 mb-5 text-center soft-shadow"
        ...
        <div class="container device">
            ...
            <div class="d-flex flex-wrap gap-3 justify-content-between">
                @foreach ($tags as $tag)
                    <a class="btn btn-outline-{{ $classes[array_rand($classes, 1)] }} rounded-element flex-fill"
                        href="{{ route('events') }}?tag={{ $tag->id }}#tabs">#{{ $tag->name }}</a>
                @endforeach
            </div>
    ...
    <section class="container device pt-5 pb-5 mt-5 mb-5">
        ...
        {{-- Action --}}
        <div class="mt-5 text-center">
            <a href="{{ route('events') }}" class="btn btn-accent rounded-element soft-shadow">Это же я!
                Приступаю.</a>
        </div>
        {{-- Action --}}
    ...
    <footer class="container-fluid text-center soft-shadow pt-5 pb-5 mt-5" style="background-color: #F8F9FA">
        <div class="container device">
            <span class="d-block">Есть вопросы, пожелания, предложения? Пишите: <a class="text-decoration-none"
                    href="https://t.me/poidu">@poidu</a></span>
            <a class="d-block" href="https://t.me/poidu"><i class="bi bi-telegram me-2"
                    style="color: #3390ec"></i></a>
        </div>
    </footer>
    {{-- Подвал --}}
    ...
    <script type="text/javascript" src="/storage/vendor/slick/slick.min.js?v<?= $v ?>"></script>
    {{-- End Add Slick --}}
