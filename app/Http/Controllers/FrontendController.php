...
class FrontendController extends Controller
{
    public function general(Request $r)
    {
        ...
        $events = Event::where('begin', '>=', date('Y-m-d'))->orderBy('begin')->get();
        ...
        $e_today = Event::whereBetween('begin', [$now, $day_end])->orderBy('begin')->get();
        // dd($e_today);
        ...
        $e_tomorrow = Event::whereBetween('begin', [$day_before_start, $day_before_end])->orderBy('begin')->get();

        // для вкладки "выходные"
        $saturday = '2022-11-19 00:00:00';
        $sunday = '2022-11-20 23:59:59';
        $e_weeckend = Event::whereBetween('begin', [$saturday, $sunday])->orderBy('begin')->get();
